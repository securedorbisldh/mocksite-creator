...
import { CheckCircle, Globe, Zap, Shield, TrendingUp, Users, Award, ArrowRight, Sparkles, Clock, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900">
              Strategic Technology <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">Partnership</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed max-w-4xl mx-auto">
              RightMediaBox has partnered with <strong>KloudBean</strong> to provide creators with enterprise-grade hosting infrastructure. This is one of our ongoing strategic partnerships designed to scale your success.
            </p>
            ...
            <div className="text-sm text-gray-500 bg-white/80 backdrop-blur-sm rounded-full px-6 py-3 inline-block">
              Part of RightMediaBox's Strategic Partnership Program • More opportunities coming soon
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-center gap-4 text-center">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Partnership Status: ACTIVE</span>
            </div>
            <div className="hidden md:block w-px h-6 bg-white/30"></div>
            <span className="text-sm opacity-90">Applications being reviewed weekly</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                Why We Choose <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">KloudBean</span>
              </h2>
              ...
              <div className="space-y-4">
                {["Managed cloud hosting optimized for creators", "Application-specific environments (WordPress, Next.js, Node.js)", "Performance monitoring with creator-focused metrics", "Priority technical support for RightMediaBox partners"].map((item, index) => (
      ...
      <div className="bg-gray-50 py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join our strategic partnership program in three simple steps
            </p>
          </div>
      ...
      <div className="py-16 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">More Strategic Partnerships Coming Soon</h2>
          <p className="text-xl opacity-90 mb-8 max-w-3xl mx-auto">
            KloudBean is just the beginning. We're continuously curating partnerships with industry leaders to provide creators with comprehensive growth solutions.
          </p>
          ...
          <div className="bg-gradient-to-r from-red-600 via-pink-600 to-orange-600 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Join successful creators who trust our strategic partnerships to power their growth and monetization strategies.
              </p>
